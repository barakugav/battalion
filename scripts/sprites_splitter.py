...
def main():
    ...
    parser.add_argument("-s", "--sprites", type=str, required=True, help="path to the input sprites file")
    parser.add_argument("-o", "--out", type=str, required=True, help="path to an output directory")
    parser.add_argument("-w", "--width", type=int, required=True, help="width of each sub image within the sprites")
    parser.add_argument("-he", "--height", type=int, required=True, help="height of each sub image within the sprites")
    parser.add_argument("-m", "--margin", type=int, default=1, help="margin between each sub image")
